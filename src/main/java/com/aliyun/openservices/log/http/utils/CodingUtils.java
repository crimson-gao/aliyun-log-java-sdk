...
public class CodingUtils {
    ...
    private static final Pattern SHARD_ID_PATTERN = Pattern.compile("^[0-9]{1,3}$");
    ...
    public static void validateShardId(String shardId) throws LogException {
        assertParameterNotNull(shardId, "shard");
        if (!SHARD_ID_PATTERN.matcher(shardId).matches()) {
            throw new LogException(ErrorCodes.INVALID_PARAMETER, "Invalid shardId: " + shardId, "");
        }
    }
